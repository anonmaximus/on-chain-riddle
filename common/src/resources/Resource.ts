...
import { ValidatorOptions, validateOrReject, validateSync, ValidationError } from "class-validator";
...
export default class Resource {
	 ...
	 */
	public static hydrate<T extends Resource>(from: T | OmitRecursively<T, "validateOrReject" | "validateOrRejectSync">, options?: ClassTransformOptions): T {
	...
	public static hydratePartial<T extends Resource>(
		from: Partial<T | OmitRecursively<T, "validateOrReject" | "validateOrRejectSync">>,
	...
	public static hydrateArray<T extends Resource>(fromArray: T[] | OmitRecursively<T[], "validateOrReject" | "validateOrRejectSync">, options?: ClassTransformOptions): T[] {
		return fromArray.map((from) => this.hydrate<T>(from, options));
	}

	public static hydratePartialArray<T extends Resource>(
		fromArray: Partial<T>[] | OmitRecursively<T[], "validateOrReject" | "validateOrRejectSync">,
		options?: ClassTransformOptions,
	): Partial<T>[] {
	...
	public static validateOrReject<T extends Resource>(object: Partial<T>, validatorOptions?: ValidatorOptions) {
	...
	public static validateOrRejectSync<T extends Resource>(object: Partial<T>, validatorOptions?: ValidatorOptions) {
		const validationError = validateSync(object, validatorOptions);
		if (validationError.length) throw validationError;
		return this;
	}
	 ...
	 */
	public static async validateArrayOrReject<T extends Resource>(objects: Partial<T>[], validatorOptions?: ValidatorOptions) {
